...
export default function Stats({ content }: StatsProps) {
  ...
  return (
    <section id="stats-section" className="py-20 bg-primary leading-relaxed text-white relative overflow-hidden">
      <div className="absolute inset-0 bg-mesh-gradient opacity-20 pointer-events-none"></div>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="text-center p-8 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm hover:bg-white/10 transition-all duration-300 group">
            <div className="w-16 h-16 mx-auto mb-6 bg-primary-light/50 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
          ...
          <div className="text-center p-8 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm hover:bg-white/10 transition-all duration-300 group">
            ...
            <h3 className="text-4xl font-serif font-bold text-white mb-2">{content.fellow}</h3>
            <p className="text-gray-300 text-sm font-semibold uppercase tracking-widest">{content.fellowLabel}</p>
          </div>

          <div className="text-center p-8 rounded-2xl bg-gradient-to-br from-accent/20 to-primary-light/20 border border-accent/20 backdrop-blur-sm hover:border-accent/40 transition-all duration-300 group">
            <div className="w-16 h-16 mx-auto mb-6 bg-accent/20 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
